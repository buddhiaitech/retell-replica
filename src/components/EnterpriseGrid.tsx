...
export default function GridLayout() {
  ...
  const content: Record<number, { title: string; description: string }> = {
    ...
    3: {
      ...
      description:
        "Enable Buddhi AI Branded Call feature to unlock new levels of customer trust and satisfaction for outbound call operations",
    },
    4: {
      title: "Reliable and Stable Platform You Can Trust",
      description:
        "With average 99.99% uptime and effortless fallback. BuddhiVoice AI ensures your phone callers are always production-ready.",
    },
  };
